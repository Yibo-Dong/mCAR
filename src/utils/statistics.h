...
class Statistics 
{
    public:
        ...
        void print() 
        {
            ...
            // std::cout << "      \"Time 1.1\": "    << time_1_1/ 1000.0 <<","<<std::endl;
            // std::cout << "      \"Time 1.2\": "    << time_1_2/ 1000.0 <<","<<std::endl;
            // std::cout << "      \"Time 1.3\": "    << time_1_3/ 1000.0 <<","<<std::endl;
            // std::cout << "      \"Time 2\": "    << time_2/ 1000.0 <<","<<std::endl;
